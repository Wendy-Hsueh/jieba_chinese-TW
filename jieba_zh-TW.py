...
jieba.load_userdict('D:/00研究所/LAB_PROJECT/03_分類平台/LDA_code/jieba_dict/userDict.txt')
with open('D:/00研究所/LAB_PROJECT/03_分類平台/LDA_code/jieba_dict/stopwords.txt', encoding = 'UTF-8') as f:
